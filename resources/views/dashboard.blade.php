    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('pacientes.index') }}"
                ...
                <div class="absolute -right-8 -top-8 h-32 w-32 bg-teal-200 dark:bg-teal-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"></div>
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-2xl font-bold text-teal-700 dark:text-teal-200">Pacientes</h2>
                        <i class="fas fa-users text-3xl text-teal-400 dark:text-teal-500 opacity-50 group-hover:opacity-100 transition-opacity"></i>
                    </div>
                    <p class="text-teal-600 dark:text-teal-300 text-sm mb-4">Gestión de datos de pacientes, historial médico y screening</p>
                    <div class="flex gap-2">
                        <span class="inline-block bg-teal-200 dark:bg-teal-800 text-teal-800 dark:text-teal-200 text-xs font-semibold px-3 py-1 rounded-full">Crear</span>
                        <span class="inline-block bg-teal-200 dark:bg-teal-800 text-teal-800 dark:text-teal-200 text-xs font-semibold px-3 py-1 rounded-full">Listar</span>
                        <span class="inline-block bg-teal-200 dark:bg-teal-800 text-teal-800 dark:text-teal-200 text-xs font-semibold px-3 py-1 rounded-full">Editar</span>
                    </div>
                </div>
            </a>

            <!-- Card: Consultas (disabled) -->
            <div class="group relative overflow-hidden rounded-xl border border-gray-300 dark:border-gray-600 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 p-6 shadow-sm opacity-75">
                <div class="absolute -right-8 -top-8 h-32 w-32 bg-gray-300 dark:bg-gray-600 rounded-full opacity-5"></div>
                <div class="relative z-10">
                    <div class="flex items-center justify-between mb-4">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm mb-4">Gestión de consultas digitales y presenciales</p>
                    <div class="inline-block bg-gray-300 dark:bg-gray-600 text-gray-600 dark:text-gray-300 text-xs font-semibold px-3 py-1 rounded-full">Próxima Fase</div>
                </div>
            </div>
        ...
        <div class="rounded-xl bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 p-6 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="flex items-center gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 opacity-50 cursor-not-allowed">
            ...
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="text-blue-800 dark:text-blue-300 text-sm mt-2">
                        Eres un usuario de la Clínica Cumpito. Actualmente puedes gestionar pacientes de forma completa (crear, ver, editar, eliminar). 
                        Las próximas fases incluirán gestión de consultas, generación de reportes y análisis estadísticos.
                    </p>
                </div>
            </div>
        </div>
