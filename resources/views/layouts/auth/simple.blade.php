    ...
    <body class="antialiased" data-auth-layout>
        <div data-auth-card>
            ...
            <a href="{{ route('home') }}" class="flex flex-col items-center gap-3 mb-8 group" wire:navigate>
                <div
                    class="h-12 w-12 bg-gradient-to-br from-teal-500 to-teal-600 dark:from-teal-400 dark:to-teal-500 rounded-2xl flex items-center justify-center group-hover:shadow-lg transition-all"
                >
