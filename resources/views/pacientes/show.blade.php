                ...
                <div class="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-700 p-5">
                    ...
                    <ul class="space-y-1.5 text-sm">
                        ...
                        <li class="flex items-center justify-between gap-2">
                            ...
                            <span
                                @class([ 'inline-block px-2 py-0.5 rounded-full text-xs font-medium flex-shrink-0' , 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300'=> $status === 'negative',
                        ...
                        <li class="flex items-center justify-between gap-2">
                            ...
                            <span
                                @class([ 'inline-block px-2 py-0.5 rounded-full text-xs font-medium flex-shrink-0' , 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300'=> $patient->heel_prick_done === true,
                    ...
                    <div class="mt-4 space-y-2">
                        ...
                        @if ($latestAppliedVaccine)
                            <div class="p-3 rounded-lg bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 flex items-start gap-2">
                                <span class="text-teal-500 text-sm">💉</span>
                                <p class="text-xs text-teal-700 dark:text-teal-300 mt-0.5">
                                    La última vacuna fue: <strong>{{ $latestAppliedVaccine->vaccine->name }}</strong>
