<x-layouts::app :title="__('Dashboard')">
    @php
        ...
        $consultasMes = App\Models\Consultation::whereMonth('created_at', date('m'))
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                @foreach (auth()->user()->getRoleNames() as $role)
                    <span
                        class="inline-flex items-center gap-1 rounded-full bg-teal-100 dark:bg-teal-900 text-teal-700 dark:text-teal-300 text-xs font-semibold px-3 py-1 border border-teal-200 dark:border-teal-700"
                    >
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                >
                    <div
                        class="absolute -right-6 -top-6 h-24 w-24 bg-teal-200 dark:bg-teal-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                    ></div>
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <span
                                class="text-xs font-semibold bg-teal-200 dark:bg-teal-700 text-teal-800 dark:text-teal-200 px-2 py-0.5 rounded-full"
                            >
                                100%
                            </span>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-1.5 mt-auto">
                            <span
                                class="text-xs bg-teal-200 dark:bg-teal-800 text-teal-800 dark:text-teal-200 px-2 py-0.5 rounded-full"
                            >
                                CRUD
                            </span>
                            <span
                ...
                >
                    <div
                        class="absolute -right-6 -top-6 h-24 w-24 bg-blue-200 dark:bg-blue-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                    ></div>
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-xs font-semibold bg-blue-200 dark:bg-blue-700 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full"
                            >
                                100%
                            </span>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-1.5 mt-auto">
                            <span
                                class="text-xs bg-blue-200 dark:bg-blue-800 text-blue-800 dark:text-blue-200 px-2 py-0.5 rounded-full"
                            >
                                SOAP
                            </span>
                            <span
                ...
                >
                    <div
                        class="absolute -right-6 -top-6 h-24 w-24 bg-indigo-200 dark:bg-indigo-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                    ></div>
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-xs font-semibold bg-indigo-200 dark:bg-indigo-700 text-indigo-800 dark:text-indigo-200 px-2 py-0.5 rounded-full"
                            >
                                100%
                            </span>
                        </div>
                        ...
                        <div class="flex flex-wrap gap-1.5 mt-auto">
                            <span
                                class="text-xs bg-indigo-200 dark:bg-indigo-800 text-indigo-800 dark:text-indigo-200 px-2 py-0.5 rounded-full"
                            >
                                Recetas
                            </span>
                            <span
                ...
                @can('create', App\Models\Consultation::class)
                    ...
                    >
                        <div
                            class="absolute -right-6 -top-6 h-24 w-24 bg-cyan-200 dark:bg-cyan-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                        ></div>
                        <div class="relative z-10 flex flex-col h-full">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-xs font-semibold bg-cyan-200 dark:bg-cyan-700 text-cyan-800 dark:text-cyan-200 px-2 py-0.5 rounded-full"
                                >
                                    100%
                                </span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-1.5 mt-auto">
                                <span
                                    class="text-xs bg-cyan-200 dark:bg-cyan-800 text-cyan-800 dark:text-cyan-200 px-2 py-0.5 rounded-full"
                                >
                                    PDF
                                </span>
                                <span
                ...
                @role('Admin')
                    ...
                    >
                        <div
                            class="absolute -right-6 -top-6 h-24 w-24 bg-amber-200 dark:bg-amber-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                        ></div>
                        <div class="relative z-10 flex flex-col h-full">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-xs font-semibold bg-amber-200 dark:bg-amber-700 text-amber-800 dark:text-amber-200 px-2 py-0.5 rounded-full"
                                >
                                    Admin
                                </span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-1.5 mt-auto">
                                <span
                                    class="text-xs bg-amber-200 dark:bg-amber-800 text-amber-800 dark:text-amber-200 px-2 py-0.5 rounded-full"
                                >
                                    Laboratorio
                                </span>
                                <span
                ...
                @role('Doctor')
                    ...
                    >
                        <div
                            class="absolute -right-6 -top-6 h-24 w-24 bg-purple-200 dark:bg-purple-700 rounded-full opacity-10 group-hover:opacity-20 transition-opacity"
                        ></div>
                        <div class="relative z-10 flex flex-col h-full">
                            <div class="flex items-start justify-between mb-3">
                                <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-xs font-semibold bg-purple-200 dark:bg-purple-700 text-purple-800 dark:text-purple-200 px-2 py-0.5 rounded-full"
                                >
                                    100%
                                </span>
                            </div>
                            ...
                            <div class="flex flex-wrap gap-1.5 mt-auto">
                                <span
                                    class="text-xs bg-purple-200 dark:bg-purple-800 text-purple-800 dark:text-purple-200 px-2 py-0.5 rounded-full"
                                >
                                    Especialidad
                                </span>
                                <span
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {{-- Últimas 5 consultas --}}
            <div
                class="lg:col-span-2 rounded-xl bg-white dark:bg-zinc-800 border border-gray-100 dark:border-zinc-700 p-5 shadow-sm"
            >
                ...
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <thead>
                                <tr
                                    class="text-xs text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-zinc-700"
                                >
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-700/50 transition">
                                        ...
                                        <td class="py-2.5 pr-3">
                                            @if ($consulta->type?->isManual())
                                                <span
                                                    class="inline-flex items-center gap-1 text-xs bg-cyan-100 dark:bg-cyan-900/50 text-cyan-700 dark:text-cyan-300 px-2 py-0.5 rounded-full"
                                                >
                                            ...
                                            @else
                                                <span
                                                    class="inline-flex items-center gap-1 text-xs bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded-full"
                                                >
                                                    <i class="fas fa-laptop-medical text-xs"></i>
                                                    Digital
                                                </span>
                                            @endif
                                        </td>
                                        <td class="py-2.5 pr-3">
                                            @if ($consulta->status?->isFinalized())
                                                <span
                                                    class="inline-flex items-center gap-1 text-xs bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300 px-2 py-0.5 rounded-full"
                                                >
                                            ...
                                            @else
                                                <span
                                                    class="inline-flex items-center gap-1 text-xs bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300 px-2 py-0.5 rounded-full"
                                                >
                                        ...
                                        <td
                                            class="py-2.5 pr-3 text-gray-500 dark:text-gray-400 text-xs whitespace-nowrap"
                                        >
        ...
        <div
            class="rounded-xl bg-gradient-to-r from-teal-600 to-teal-700 dark:from-teal-800 dark:to-teal-900 p-5 shadow-sm"
        >
