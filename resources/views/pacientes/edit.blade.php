        ...
        <form action="{{ route('pacientes.update', $patient->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        >
                            ...
                            <option
                                value="Normal"
                                @selected(old('birth_type', $patient->birth_type?->value()) === 'Normal')
                            >
                                Parto Normal
                            </option>
                            <option
                                value="Cesarean"
                                @selected(old('birth_type', $patient->birth_type?->value()) === 'Cesarean')
                            >
                                Cesárea
                            </option>
                        </select>
            ...
            <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    >
                        <label class="block text-xs font-bold text-teal-800 dark:text-teal-300 uppercase mb-2">
                            Grupo Sanguíneo
                        </label>
                        <select
                            name="blood_group"
                        ...
                        >
                            ...
                            @foreach (['O+', 'O-', 'A+', 'A-', 'B+', 'B-', 'AB+', 'AB-'] as $group)
                                <option
                                    value="{{ $group }}"
                                    @selected(old('blood_group', $patient->blood_group?->value()) === $group)
                                >
                                    {{ $group }}
                                </option>
                            @endforeach
