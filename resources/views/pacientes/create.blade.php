<x-layouts::app :title="__('Crear Paciente')">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-2">Ingrese los datos base para iniciar el historial.</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-2">
                    ...
                    <input type="text" name="full_name" placeholder="Ej: Aitana Aguilar"
                        ...
                        @error('full_name') border-red-500 dark:border-red-600 @enderror"
                        value="{{ old('full_name') }}">
                    @error('full_name')
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth"
                        class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg shadow-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500
                        @error('date_of_birth') border-red-500 dark:border-red-600 @enderror"
                ...
                <div>
                    ...
                    <select name="gender"
                        class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg shadow-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500
                        @error('gender') border-red-500 dark:border-red-600 @enderror">
        ...
        <div class="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-teal-50 dark:bg-teal-900/30 p-3 rounded-lg border border-teal-100 dark:border-teal-800">
                    <label class="block text-xs font-bold text-teal-800 dark:text-teal-400 uppercase mb-2">Grupo Sanguíneo</label>
            ...
            <!-- Condiciones Médicas -->
            <div class="mb-6">
                <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-3">Condiciones Médicas Detectadas</label>
                <div class="space-y-2">
                    @foreach ($conditions as $condition)
                        <div class="flex items-center p-3 border border-gray-200 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 bg-white dark:bg-zinc-900">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea name="pathologies" rows="2"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg shadow-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500">{{ old('pathologies') }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="surgeries" rows="2"
                            class="w-full px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg shadow-sm bg-white dark:bg-zinc-800 text-gray-900 dark:text-gray-100 focus:ring-teal-500 focus:border-teal-500">{{ old('surgeries') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
